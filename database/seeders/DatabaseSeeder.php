...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $product = Product::updateOrCreate(['sku' => 'PLA-DEC-01'], ['name' => 'Placa decorativa personalizada', 'type' => 'product', 'base_price' => 89, 'production_cost' => 42.50, 'made_to_order' => true, 'description' => 'Produto personalizável para a loja virtual.']);
