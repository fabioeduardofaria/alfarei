...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/store.css') }}"><link rel="stylesheet" href="{{ asset('css/store-extra.css') }}"><link rel="stylesheet" href="{{ asset('css/store-discovery.css') }}?v={{ filemtime(public_path('css/store-discovery.css')) }}">
...
<header class="store-header"><a href="{{ route('loja.index') }}" class="store-brand"><img src="{{ asset('images/alfarei-logo.png') }}" alt="{{ $settings->store_name }}"></a><nav aria-label="Navegação principal"><a href="{{ route('loja.index') }}#descobrir">Descobrir</a><a href="{{ route('loja.index') }}#catalogo">Produtos</a><a href="{{ route('loja.index') }}#como-funciona">Como funciona</a><a href="{{ route('loja.tracking') }}">Rastrear pedido</a><a class="cart-link" href="{{ route('loja.cart') }}">Carrinho <b>{{ $cartCount }}</b></a></nav><details class="store-mobile-menu"><summary>Menu <span aria-hidden="true">☰</span></summary><div><a href="{{ route('loja.index') }}#descobrir">Descobrir</a><a href="{{ route('loja.index') }}#catalogo">Produtos</a><a href="{{ route('loja.index') }}#como-funciona">Como funciona</a><a href="{{ route('loja.tracking') }}">Rastrear pedido</a><a href="{{ route('loja.cart') }}">Carrinho ({{ $cartCount }})</a></div></details></header>
